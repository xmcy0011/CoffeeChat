...
func (tx *Tx) init() {
	tx.MessageRecv = NewMessageRecvClient(tx.config)
	tx.MessageSend = NewMessageSendClient(tx.config)
...
// applies a query, for example: MessageRecv.QueryXXX(), the query will be executed
