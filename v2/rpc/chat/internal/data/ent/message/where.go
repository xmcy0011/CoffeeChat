...
func CreateTime(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
...
func CreateTimeEQ(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreateTime), v))
	})
}
...
func CreateTimeNEQ(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
...
func CreateTimeIn(vs ...int32) predicate.Message {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateTimeNotIn(vs ...int32) predicate.Message {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateTimeGT(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
...
func CreateTimeGTE(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
...
func CreateTimeLT(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
...
func CreateTimeLTE(v int32) predicate.Message {
	return predicate.Message(func(s *sql.Selector) {
