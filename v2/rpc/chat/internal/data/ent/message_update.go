...
func (mu *MessageUpdate) SetCreateTime(i int32) *MessageUpdate {
...
func (mu *MessageUpdate) AddCreateTime(i int32) *MessageUpdate {
...
// SetCreateTime sets the "create_time" field.
func (muo *MessageUpdateOne) SetCreateTime(i int32) *MessageUpdateOne {
...
// AddCreateTime adds i to the "create_time" field.
func (muo *MessageUpdateOne) AddCreateTime(i int32) *MessageUpdateOne {
