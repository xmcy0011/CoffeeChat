...
func (m *MessageMutation) SetCreateTime(i int32) {
	m.create_time = &i
	m.addcreate_time = nil
}

// CreateTime returns the value of the "create_time" field in the mutation.
func (m *MessageMutation) CreateTime() (r int32, exists bool) {
	v := m.create_time
	if v == nil {
		return
	}
...
// If the Message object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MessageMutation) OldCreateTime(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MessageMutation) AddCreateTime(i int32) {
...
func (m *MessageMutation) AddedCreateTime() (r int32, exists bool) {
	v := m.addcreate_time
	if v == nil {
		return
	}
