...
func (sq *SessionQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (sq *SessionQuery) FirstIDX(ctx context.Context) int32 {
...
func (sq *SessionQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (sq *SessionQuery) OnlyIDX(ctx context.Context) int32 {
...
func (sq *SessionQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (sq *SessionQuery) IDsX(ctx context.Context) []int32 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
