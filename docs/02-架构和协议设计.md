...
|表名|描述|拆分方式|举例|
|-|-|-|-|
|im_message_send|用户发送的消息|按照hash(msg_from)%4取模，拆分4个库|im_message_send_0、……、im_message_send_3
|im_message_recv|用户接收的消息|按照hash(msg_to)%4取模，拆分4个库|im_message_recv_0、……、im_message_recv_3|
