...
import 'badge_bottom_tab_bar_item.dart';
...
/// Defines the layout and behavior of a [BadgeBottomTabBar].
///
/// See also:
///
///  * [BadgeBottomTabBar]
...
enum BottomTabBarType {
  /// The [BadgeBottomTabBar]'s [BadgeBottomTabBarItem]s have fixed width, always
  /// display their text labels, and do not shift when tapped.
  fixed,

  /// The location and size of the [BottomTabBar] [BadgeBottomTabBarItem]s
...
/// ## Sample Code
///
/// This example shows a [BadgeBottomTabBar] as it is used within a [Scaffold]
/// widget. The [BadgeBottomTabBar] has three [BadgeBottomTabBarItem]
...
class BadgeBottomTabBar extends StatefulWidget {
  ...
  /// [ThemeData.primaryColor], is used. However if [BadgeBottomTabBar.type] is
  ...
  final List<BadgeBottomTabBarItem> items;
  ...
  /// The size of all of the [BadgeBottomTabBarItem] icons.
  ///
  /// See [BadgeBottomTabBarItem.icon] for more information.
  final double iconSize;

  @override
  _BadgeBottomTabBarState createState() => _BadgeBottomTabBarState();
}
...
class _BottomNavigationTile extends StatelessWidget {
  ...
  final BottomTabBarType type;
  final BadgeBottomTabBarItem item;
...
class _BadgeBottomTabBarState extends State<BadgeBottomTabBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(BadgeBottomTabBar oldWidget) {
...
class _Circle {
  ...
  final _BadgeBottomTabBarState state;
  final int index;
  final Color color;
