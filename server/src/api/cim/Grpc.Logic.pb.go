...
type CIMInternalMsgData struct {
	...
	MsgData *CIMMsgData `protobuf:"bytes,4,opt,name=msg_data,json=msgData,proto3" json:"msg_data,omitempty"` // 消息
}

func (x *CIMInternalMsgData) Reset() {
	*x = CIMInternalMsgData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_Grpc_Logic_proto_msgTypes[0]
...
func (*CIMInternalMsgData) Descriptor() ([]byte, []int) {
	return file_Grpc_Logic_proto_rawDescGZIP(), []int{0}
}

func (x *CIMInternalMsgData) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *CIMInternalMsgData) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *CIMInternalMsgData) GetServer() string {
	if x != nil {
		return x.Server
	}
	return ""
...
var file_Grpc_Logic_proto_rawDesc = []byte{
	...
	0x22, 0x8b, 0x01, 0x0a, 0x12, 0x43, 0x49, 0x4d, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x4d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x63, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x69, 0x63, 0x6b, 0x4e,
	0x61, 0x6d, 0x65, 0x52, 0x73, 0x70, 0x22, 0x00, 0x42, 0x09, 0x48, 0x03, 0x5a, 0x05, 0x2e, 0x3b,
	0x63, 0x69, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_Grpc_Logic_proto_rawDescOnce sync.Once
	file_Grpc_Logic_proto_rawDescData = file_Grpc_Logic_proto_rawDesc
)

func file_Grpc_Logic_proto_rawDescGZIP() []byte {
	file_Grpc_Logic_proto_rawDescOnce.Do(func() {
		file_Grpc_Logic_proto_rawDescData = protoimpl.X.CompressGZIP(file_Grpc_Logic_proto_rawDescData)
	})
	return file_Grpc_Logic_proto_rawDescData
}

var file_Grpc_Logic_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_Grpc_Logic_proto_goTypes = []interface{}{
	(*CIMInternalMsgData)(nil),         // 0: CIM.Grpc.CIMInternalMsgData
	(*CIMMsgData)(nil),                 // 1: CIM.Message.CIMMsgData
	(*Hello)(nil),                      // 2: CIM.Grpc.Hello
	(*CIMHeartBeat)(nil),               // 3: CIM.Login.CIMHeartBeat
	(*CIMAuthTokenReq)(nil),            // 4: CIM.Login.CIMAuthTokenReq
	(*CIMRecentContactSessionReq)(nil), // 5: CIM.List.CIMRecentContactSessionReq
	(*CIMGetMsgListReq)(nil),           // 6: CIM.List.CIMGetMsgListReq
	...
	(*Empty)(nil),                      // 10: CIM.Grpc.Empty
	(*CIMAuthTokenRsp)(nil),            // 11: CIM.Login.CIMAuthTokenRsp
	(*CIMRecentContactSessionRsp)(nil), // 12: CIM.List.CIMRecentContactSessionRsp
	(*CIMGetMsgListRsp)(nil),           // 13: CIM.List.CIMGetMsgListRsp
	(*CIMMsgDataAck)(nil),              // 14: CIM.Message.CIMMsgDataAck
	(*CreateUserAccountInfoRsp)(nil),   // 15: CIM.Grpc.CreateUserAccountInfoRsp
	(*QueryUserNickNameRsp)(nil),       // 16: CIM.Grpc.QueryUserNickNameRsp
}
var file_Grpc_Logic_proto_depIdxs = []int32{
	1,  // 0: CIM.Grpc.CIMInternalMsgData.msg_data:type_name -> CIM.Message.CIMMsgData
	2,  // 1: CIM.Grpc.Logic.SayHello:input_type -> CIM.Grpc.Hello
	3,  // 2: CIM.Grpc.Logic.Ping:input_type -> CIM.Login.CIMHeartBeat
	4,  // 3: CIM.Grpc.Logic.AuthToken:input_type -> CIM.Login.CIMAuthTokenReq
	5,  // 4: CIM.Grpc.Logic.RecentContactSession:input_type -> CIM.List.CIMRecentContactSessionReq
	6,  // 5: CIM.Grpc.Logic.GetMsgList:input_type -> CIM.List.CIMGetMsgListReq
	0,  // 6: CIM.Grpc.Logic.SendMsgData:input_type -> CIM.Grpc.CIMInternalMsgData
	...
	10, // 10: CIM.Grpc.Logic.SayHello:output_type -> CIM.Grpc.Empty
	3,  // 11: CIM.Grpc.Logic.Ping:output_type -> CIM.Login.CIMHeartBeat
	11, // 12: CIM.Grpc.Logic.AuthToken:output_type -> CIM.Login.CIMAuthTokenRsp
	12, // 13: CIM.Grpc.Logic.RecentContactSession:output_type -> CIM.List.CIMRecentContactSessionRsp
	13, // 14: CIM.Grpc.Logic.GetMsgList:output_type -> CIM.List.CIMGetMsgListRsp
	14, // 15: CIM.Grpc.Logic.SendMsgData:output_type -> CIM.Message.CIMMsgDataAck
	10, // 16: CIM.Grpc.Logic.ReadAckMsgData:output_type -> CIM.Grpc.Empty
	15, // 17: CIM.Grpc.Logic.CreateUser:output_type -> CIM.Grpc.CreateUserAccountInfoRsp
	16, // 18: CIM.Grpc.Logic.QueryUserNickName:output_type -> CIM.Grpc.QueryUserNickNameRsp
...
func file_Grpc_Logic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Grpc_Logic_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_Grpc_Logic_proto_msgTypes,
	}.Build()
...
type LogicClient interface {
	...
	// 发消息
	SendMsgData(ctx context.Context, in *CIMInternalMsgData, opts ...grpc.CallOption) (*CIMMsgDataAck, error)
	// 已读消息回执
...
func (c *logicClient) SendMsgData(ctx context.Context, in *CIMInternalMsgData, opts ...grpc.CallOption) (*CIMMsgDataAck, error) {
...
type LogicServer interface {
	...
	// 发消息
	SendMsgData(context.Context, *CIMInternalMsgData) (*CIMMsgDataAck, error)
	// 已读消息回执
...
func (*UnimplementedLogicServer) SendMsgData(context.Context, *CIMInternalMsgData) (*CIMMsgDataAck, error) {
...
func _Logic_SendMsgData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogicServer).SendMsgData(ctx, req.(*CIMInternalMsgData))
	}
	return interceptor(ctx, in, info, handler)
}
