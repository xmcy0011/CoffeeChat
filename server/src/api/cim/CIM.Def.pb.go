...
const (
	...
	CIMCmdID_kCIM_CID_LOGIN_AUTH_TOKEN_REQ            CIMCmdID = 257 // 认证请求
...
const (
	...
	// 通用错误码
	CIMErrorCode_kCIM_ERR_SUCCSSE        CIMErrorCode = 200 // 成功
...
type CIMPushMsg_CIMPushMsgType int32

const (
	CIMPushMsg_kCIM_UNKNOWN   CIMPushMsg_CIMPushMsgType = 0 // 未知
	CIMPushMsg_kCIM_PUSH      CIMPushMsg_CIMPushMsgType = 1 // 给某个用户推送
	CIMPushMsg_kCIM_ROOM      CIMPushMsg_CIMPushMsgType = 2 // 给群内所有成员推送
	CIMPushMsg_kCIM_BROADCAST CIMPushMsg_CIMPushMsgType = 3 // 给系统所有用户广播
)

// Enum value maps for CIMPushMsg_CIMPushMsgType.
var (
	CIMPushMsg_CIMPushMsgType_name = map[int32]string{
		0: "kCIM_UNKNOWN",
		1: "kCIM_PUSH",
		2: "kCIM_ROOM",
		3: "kCIM_BROADCAST",
	}
	CIMPushMsg_CIMPushMsgType_value = map[string]int32{
		"kCIM_UNKNOWN":   0,
		"kCIM_PUSH":      1,
		"kCIM_ROOM":      2,
		"kCIM_BROADCAST": 3,
...
func (x CIMPushMsg_CIMPushMsgType) Enum() *CIMPushMsg_CIMPushMsgType {
	p := new(CIMPushMsg_CIMPushMsgType)
	*p = x
	return p
}

func (x CIMPushMsg_CIMPushMsgType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CIMPushMsg_CIMPushMsgType) Descriptor() protoreflect.EnumDescriptor {
	return file_CIM_Def_proto_enumTypes[13].Descriptor()
}

func (CIMPushMsg_CIMPushMsgType) Type() protoreflect.EnumType {
	return &file_CIM_Def_proto_enumTypes[13]
}

func (x CIMPushMsg_CIMPushMsgType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CIMPushMsg_CIMPushMsgType.Descriptor instead.
func (CIMPushMsg_CIMPushMsgType) EnumDescriptor() ([]byte, []int) {
	return file_CIM_Def_proto_rawDescGZIP(), []int{4, 0}
}
...
type CIMPushMsg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CommondId uint32                    `protobuf:"varint,1,opt,name=commond_id,json=commondId,proto3" json:"commond_id,omitempty"`             // 消息ID
	ServiceId uint32                    `protobuf:"varint,2,opt,name=service_id,json=serviceId,proto3" json:"service_id,omitempty"`             // 模块ID
	Server    string                    `protobuf:"bytes,3,opt,name=server,proto3" json:"server,omitempty"`                                     // 来源服务器
	Type      CIMPushMsg_CIMPushMsgType `protobuf:"varint,4,opt,name=type,proto3,enum=CIM.Def.CIMPushMsg_CIMPushMsgType" json:"type,omitempty"` // 类型
	ToId      uint64                    `protobuf:"varint,5,opt,name=toId,proto3" json:"toId,omitempty"`                                        // 目标ID，type=ROOM，代表群ID。type=PUSH，代表用户ID
	Data      []byte                    `protobuf:"bytes,6,opt,name=data,proto3" json:"data,omitempty"`                                         // 数据
}

func (x *CIMPushMsg) Reset() {
	*x = CIMPushMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_CIM_Def_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CIMPushMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CIMPushMsg) ProtoMessage() {}

func (x *CIMPushMsg) ProtoReflect() protoreflect.Message {
	mi := &file_CIM_Def_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CIMPushMsg.ProtoReflect.Descriptor instead.
func (*CIMPushMsg) Descriptor() ([]byte, []int) {
	return file_CIM_Def_proto_rawDescGZIP(), []int{4}
}

func (x *CIMPushMsg) GetCommondId() uint32 {
	if x != nil {
		return x.CommondId
	}
	return 0
...
func (x *CIMPushMsg) GetServiceId() uint32 {
	if x != nil {
		return x.ServiceId
	}
	return 0
...
func (x *CIMPushMsg) GetServer() string {
	if x != nil {
		return x.Server
	}
	return ""
...
func (x *CIMPushMsg) GetType() CIMPushMsg_CIMPushMsgType {
	if x != nil {
		return x.Type
	}
	return CIMPushMsg_kCIM_UNKNOWN
}

func (x *CIMPushMsg) GetToId() uint64 {
	if x != nil {
		return x.ToId
	}
	return 0
...
func (x *CIMPushMsg) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_CIM_Def_proto_rawDesc = []byte{
	...
	0x07, 0x43, 0x49, 0x4d, 0x2e, 0x44, 0x65, 0x66, 0x22, 0x64, 0x0a, 0x0b, 0x43, 0x49, 0x4d, 0x55,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6e, 0x69, 0x63, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a,
	0x0b, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xef,
	0x04, 0x0a, 0x15, 0x43, 0x49, 0x4d, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x53, 0x65, 0x73,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x42, 0x22, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x66, 0x66, 0x65, 0x65, 0x63,
	0x68, 0x61, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x48, 0x03, 0x5a, 0x05,
	0x2e, 0x3b, 0x63, 0x69, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_CIM_Def_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_CIM_Def_proto_goTypes = []interface{}{
	...
	(CIMSessionStatusType)(0),      // 7: CIM.Def.CIMSessionStatusType
	(CIMMsgFeature)(0),             // 8: CIM.Def.CIMMsgFeature
	(CIMVoipInviteType)(0),         // 9: CIM.Def.CIMVoipInviteType
	(CIMInviteRspCode)(0),          // 10: CIM.Def.CIMInviteRspCode
	(CIMVoipByeReason)(0),          // 11: CIM.Def.CIMVoipByeReason
	(CIMResCode)(0),                // 12: CIM.Def.CIMResCode
	(CIMPushMsg_CIMPushMsgType)(0), // 13: CIM.Def.CIMPushMsg.CIMPushMsgType
	...
	(*CIMPushMsg)(nil),             // 18: CIM.Def.CIMPushMsg
}
var file_CIM_Def_proto_depIdxs = []int32{
	4,  // 0: CIM.Def.CIMContactSessionInfo.session_type:type_name -> CIM.Def.CIMSessionType
	7,  // 1: CIM.Def.CIMContactSessionInfo.session_status:type_name -> CIM.Def.CIMSessionStatusType
	...
	12, // 4: CIM.Def.CIMMsgInfo.msg_res_code:type_name -> CIM.Def.CIMResCode
	8,  // 5: CIM.Def.CIMMsgInfo.msg_feature:type_name -> CIM.Def.CIMMsgFeature
	...
	13, // 10: CIM.Def.CIMPushMsg.type:type_name -> CIM.Def.CIMPushMsg.CIMPushMsgType
...
func file_CIM_Def_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_CIM_Def_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CIMPushMsg); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
