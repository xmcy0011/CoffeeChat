...
var (
	accessKey = os.Getenv("Xn6brXY2XiyUTCzXt7Sk2Oa22kQcis9cOh3kYU94")
	secretKey = os.Getenv("vt7FjjAbcxT7rY7P8vJuAd-uRu03-YTER1pLMJgT")
	bucket    = os.Getenv("coffeechat")
)

func printUploadToken(){
